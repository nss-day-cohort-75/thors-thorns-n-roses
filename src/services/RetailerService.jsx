...
export const getRetailerDetails = async () => {
    try {
        const [retailers, distributors, flowers, nurseryFlowers, nurseries] = await Promise.all([
            getRetailers(),
            getDistributors(),
            getFlowers(),
            getNurseryFlowers(),
        ...
        return retailers.map((retailer) => {
            ...
            return {
                ...retailer,
                distributor,
                flowers: supplierNurseries,
                nurseries: nurseries.filter(n => supplierNurseries.some(f => f.nurseryId === n.id))
            };
        });
    } catch (error) {
